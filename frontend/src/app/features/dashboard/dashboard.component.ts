...
export class DashboardComponent {
  ...
  readonly quickActions: QuickAction[] = [
    ...
    },
    {
      ...
      roles: ['super_admin', 'complex_admin']
    }
  ];
  ...
  private loadStats(): void {
    ...
    forkJoin({
      ...
      complexes: this.complexService.getComplexes({
        per_page: 1
      }),
      ...
      .subscribe({
        next: ({ admins, complexes, buildings }) => {
          this.stats.update(current => [
            {
              ...current[0],
              value: admins.data?.pagination.total ?? 0
            },
            {
              ...current[1],
              value: complexes.data?.pagination.total ?? 0
            },
            {
              ...current[2],
              value: buildings.data?.pagination.total ?? 0
            }
          ]);
        },
